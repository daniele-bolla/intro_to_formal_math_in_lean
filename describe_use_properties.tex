...
solve certain decidable propositions.
\begin{example}
...
like \lstinline[language=lean]|ℕ|, \lstinline[language=lean]|ℤ|,
and \lstinline[language=lean]|ℚ|
are distinct and do not have a subtype relationship.
In order to translate between these types,
...
Morover it helps to split the code. First we prove the underlying property on
...
With the use of type classes such as \lstinline[language=lean]|PartialOrder|,
...
This approach is at the foundation of Mathlib's design philosophy.
...
constructive mathematics, is not directly computable.
...
at the cost of computability.
Most operations on real numbers must be
...
working with real numbers and topological spaces.
The latter provides
