...
reflecting Lean's robust filter engine. Conversely, manipulating paths proved tedious.
...
but rather a contingency of Mathlib's current design choices.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{img/topologist_sine_curve.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{img/topologist_sine_curve_with_ball.png}
  \caption{Topologist's sine curve with ball around $(0,0)$.}
  \label{fig:sine-curve-ball}
\end{figure}
\begin{lstlisting}[language=lean]
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{img/sine_curve_peaks.png}
