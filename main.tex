...
\begin{declaration}
    ...
    sources have been used except those indicated in the bibliography.
    I confirm that generative AI tools were not used in developing any
    part of this thesis, though they may have been used for preliminary
    research purposes and flow refinement.

    \vspace{2cm}

    \noindent
    \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l r}
        \textbf{Place, Date} & \textbf{Signature} \\[0.4cm]

        Omegna (Italy), 9 December 2025 &
        \raisebox{-0.5\height}{\includegraphics[height=1.4cm]{img/signature.png}}
        \\[0.3cm]

        \rule{4cm}{0.5pt} & \rule{6cm}{0.5pt}
    \end{tabular*}
\end{declaration}
...
\input{intro}
\input{logic_prop_as_types}
\input{structures_typeclasses_coercions.tex}
\input{quotients_and_hierarchy.tex}
\input{topology_in_lean.tex}
\input{topologist_sine_curve}
