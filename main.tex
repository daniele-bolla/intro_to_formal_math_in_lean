...
\def\lstlanguagefiles{lstlean.tex, lsttypescript.tex, lstjavascript.tex} % specify the files to load
% \lstloadlanguages{lean, TypeScript} % load the languages
% \lstloadlanguages{lean, Javascript} % load the languages
