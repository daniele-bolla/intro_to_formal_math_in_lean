...
by providing proofs that the bounds $[0, 1]$ are satisfied.
...
\lstinline[language=lean]|simpa only [a, ← hx_eq] using hxI| completes the proof.
...
so infinitely many of them lie in any interval $[0, a]$ with $a > 0$.
