...
of length $n$, where $n$ is a value (a natural number). This capability makes dependent type theory
...
A fundamental design feature of Lean is its type structure, where \textbf{Prop} (the proposition type)
plays a special role and exhibits \textbf{proof irrelevance}.
Proof irrelevance means that all proofs of a given proposition are treated
as definitionally equivalent in type theory.
What matters is simply whether a proposition is provable, not which specific proof is provided.
